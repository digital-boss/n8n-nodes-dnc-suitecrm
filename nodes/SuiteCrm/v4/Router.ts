...
export async function router(this: IExecuteFunctions): Promise<INodeExecutionData[][]> {
    ...
    for (let i = 0; i < length; i++) {
        ...
        if (resource === 'login') {
            ...
            body.link_name_to_fields_array = this.getNodeParameter('link_name_to_fields_array', 0) as IDataObject[];
            ...
            body.related_module_link_name_to_fields_array = this.getNodeParameter('related_module_link_name_to_fields_array', 0) as IDataObject[];
            body.deleted = this.getNodeParameter('deleted', 0) as boolean;
            body.order_by = this.getNodeParameter('order_by', 0) as string;
            body.offset = this.getNodeParameter('offset', 0) as number;
