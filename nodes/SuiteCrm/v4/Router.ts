...
export async function router(
  ...
  for (let i = 0; i < length; i++) {
    ...
    if (resource === "login") {
      const user = (this.getNodeParameter("user_auth", 0) as IDataObject)
      ...
      user.password = crypto
        ...
        .toString();
      body.user_auth = user;
      body.application_name = this.getNodeParameter(
        "application_name",
        0
      ) as string;
      body.name_value_list = (
        this.getNodeParameter("name_value_list", 0) as IDataObject
      )?.value;
      ...
      body.select_fields = this.getNodeParameter(
        "select_fields",
        0
      ) as IDataObject[];
      ...
      body.session = this.getNodeParameter("session", 0) as string;
      body.module_names = this.getNodeParameter(
        "module_names",
        0
      ) as IDataObject[];
      ...
      body.session = this.getNodeParameter("session", 0) as string;
      body.module_name = this.getNodeParameter("module_name", 0) as string;
      body.related_module = this.getNodeParameter(
        "related_module",
        0
      ) as string;
      ...
      body.max_results = this.getNodeParameter("max_results", 0) as number;
      body.deleted = this.getNodeParameter("deleted", 0) as boolean;
      body.module_user_id = this.getNodeParameter(
        "module_user_id",
        0
      ) as string;
      body.select_fields = this.getNodeParameter(
      ...
      body.relationship_name = this.getNodeParameter(
        "relationship_name",
        0
      ) as string;
      ...
      body.link_field_name = this.getNodeParameter(
        "link_field_name",
        0
      ) as string;
      body.related_module_query = this.getNodeParameter(
        "related_module_query",
        0
      ) as string;
      body.related_fields = this.getNodeParameter(
        "related_fields",
        0
      ) as IDataObject[];
      ...
      body.offset = this.getNodeParameter("offset", 0) as number;
      body.max_results = this.getNodeParameter("max_results", 0) as number;
      body.assigned_user_id = this.getNodeParameter(
        "assigned_user_id",
        0
      ) as string;
      body.select_fields = this.getNodeParameter(
      ...
      body.unified_search_only = this.getNodeParameter(
        "unified_search_only",
        0
      ) as boolean;
      body.favorites = this.getNodeParameter("favorites", 0) as boolean;
      ...
      body.name_value_lists = this.getNodeParameter(
        "name_value_lists",
        0
      ) as IDataObject[];
      ...
      body.related_ids = this.getNodeParameter(
        "related_ids",
        0
      ) as IDataObject[];
      body.name_value_list = this.getNodeParameter(
        "name_value_list",
        0
      ) as IDataObject[];
      ...
      body.link_field_names = this.getNodeParameter(
        "link_field_names",
        0
      ) as IDataObject[];
      body.related_ids = this.getNodeParameter(
      ...
      body.delete_array = this.getNodeParameter(
        "delete_array",
        0
      ) as IDataObject[];
