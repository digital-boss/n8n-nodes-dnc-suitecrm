...
const suiteCrmOperations: INodeProperties[] = [
	...
	},
	{
		...
		options: [
			...
			{
				name: 'Get Modified Relationship',
...
const suiteCrmFields: INodeProperties[] = [
	...
	// get_available_modules
	{
		...
		displayOptions: {
			show: {
				resource: ['get_available_modules'],
			},
		},
	},
	{
	...
	// get_document_revision
	{
		...
		displayOptions: {
			show: {
				resource: ['get_document_revision'],
			},
		},
	},
	{
	...
	// get_language_definition
	{
		...
		displayOptions: {
			show: {
				resource: ['get_language_definition'],
			},
		},
	},
	{
	...
	},
	{
		...
		default: '',
		description:
			"The related module to retrieve records for. One of 'Meetings', 'Calls ' or 'Contacts '.",
		displayOptions: {
			show: {
				resource: ['get_modified_relationships'],
			},
	...
	// get_module_fields_md5
	{
		...
		displayOptions: {
			show: {
				resource: ['get_module_fields_md5'],
			},
		},
	},
	{
	...
	// get_module_layout_md5
	{
		...
		displayOptions: {
			show: {
				resource: ['get_module_layout_md5'],
			},
		},
	},
	{
	...
	// get_upcoming_activities
	{
		...
		displayOptions: {
			show: {
				resource: ['get_upcoming_activities'],
			},
		},
	},
	...
	// set_document_revision
	{
		...
		displayOptions: {
			show: {
				resource: ['set_document_revision'],
			},
		},
	},
	{
...
export const versionDescription: INodeProperties[] = [...suiteCrmOperations, ...suiteCrmFields];
